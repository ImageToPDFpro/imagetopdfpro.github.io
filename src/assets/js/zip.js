/**
 * Tiny ZIP writer (STORE method, no compression). PDFs are already compressed,
 * so storing them keeps this fast and small. Supports UTF-8 file names.
 */
...
/**
 * @param {{name:string, data:Blob|Uint8Array, date?:Date}[]} files
